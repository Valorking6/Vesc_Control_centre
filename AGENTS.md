...
* **Background Service (`VescService.kt`):** Foreground service with `connectedDevice|location` types. Handles BLE comms, audio simulation, GPX/CSV logging, Health Connect sync, and ongoing lock screen notifications.
